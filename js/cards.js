/* ============================================================
   ...
   NO APOSTROPHES inside the text - write "it is", never the short
   form. An apostrophe ends the quote early and breaks the game.
...
var CARDS = [
  ...
  { text: 'Rain starting, washing on the line', theme: 'house', box: 'now', tier: 1,
    why: 'Two minutes now, or the whole load done again.' },
  { text: 'Pet bowl empty since this morning', theme: 'house', box: 'now', tier: 1,
    why: 'They cannot fix it themselves. You have to.' },
  ...
  { text: 'Milk spilled all over the floor', theme: 'house', box: 'now', tier: 1,
    why: 'It only gets harder to clean the longer it sits.' },
  ...
  { text: 'Learn to cook one meal properly', theme: 'house', box: 'later', tier: 1,
  ...
  { text: 'Change your sheets, been a month', theme: 'house', box: 'later', tier: 1,
  ...
  /* ---------- house: GIVE AWAY ----------
     ...
     a guess about WHO. */
  { text: 'Dishes needed now, it is your brother turn', theme: 'house', box: 'give', tier: 1,
  ...
  { text: 'Rewatch a show you have seen', theme: 'house', box: 'drop', tier: 1,
    why: 'Neither important nor urgent. Drop it.' },
  ...
  { text: 'Watch someone else unbox something', theme: 'house', box: 'drop', tier: 1,
    why: 'Their parcel, their day. Not yours.' },
  { text: 'Watch a video you already saw yesterday', theme: 'house', box: 'drop', tier: 1,
    why: 'You know how it ends. Move on.' },
  { text: 'Keep watching after you stopped enjoying it', theme: 'house', box: 'drop', tier: 1,
    why: 'You already got bored. That is the signal to stop.' },
  ...
  { text: 'Test tomorrow, you have not revised', theme: 'school', box: 'now', tier: 1,
    why: 'Important and due tomorrow. Nothing else beats it.' },
  ...
  { text: 'Essay unsaved, laptop battery at 2%', theme: 'school', box: 'now', tier: 2,
    why: 'Two minutes from losing everything. Save it.' },
  ...
  { text: 'Start revision notes, exam in 3 weeks', theme: 'school', box: 'later', tier: 1,
  ...
  { text: 'Read the set book before next month', theme: 'school', box: 'later', tier: 1,
  ...
  /* ---------- school: GIVE AWAY ---------- */
  { text: 'Class chat needs today homework list', theme: 'school', box: 'give', tier: 1,
    why: 'Quick, urgent, and anyone in the class can post it.' },
  { text: 'Group wants a photo of today notes', theme: 'school', box: 'give', tier: 1,
    why: 'Anyone who was in class can send it.' },
  ...
  { text: 'Notes need photocopying before next class', theme: 'school', box: 'give', tier: 2,
    why: 'Urgent and mechanical. Anyone with the notes can do it.' },
  ...
  { text: 'Argue with a stranger online', theme: 'school', box: 'drop', tier: 1,
    why: 'Costs an hour, changes nothing.' },
  { text: 'Doodle on the back of your book again', theme: 'school', box: 'drop', tier: 1,
    why: 'Fine in a break. Not a task.' },
  ...
  { text: 'Storage full, nothing will save', theme: 'phone', box: 'now', tier: 2,
    why: 'Nothing else on the phone works until you clear some.' },
  ...
  { text: 'Phone bill due today or the line is cut', theme: 'phone', box: 'now', tier: 3,
    why: 'Feels like an adult job. Miss it and you lose your phone.' },

  /* ---------- phone: DO LATER ---------- */
  { text: 'Storage nearly full, back up photos', theme: 'phone', box: 'later', tier: 2,
    why: 'Five minutes today, or lose the lot when it dies.' },
  { text: 'Same password for 3 years, change it', theme: 'phone', box: 'later', tier: 2,
  ...
  { text: 'Turn off the alerts that wake you at night', theme: 'phone', box: 'later', tier: 3,
  ...
  /* ---------- phone: GIVE AWAY ---------- */
  { text: 'Chat needs the homework photo', theme: 'phone', box: 'give', tier: 1,
    why: 'Anyone who was in class can send it.' },
  ...
  { text: 'Friend needs a charger, three people have one', theme: 'phone', box: 'give', tier: 2,
    why: 'Urgent for them, solved by anyone.' },
  ...
  { text: 'Group needs someone to book the table', theme: 'phone', box: 'give', tier: 3,
  ...
  { text: 'Count your followers again', theme: 'phone', box: 'drop', tier: 1,
  ...
  { text: 'Refresh a page waiting for nothing', theme: 'phone', box: 'drop', tier: 2,
    why: 'There is no update. You are just filling time.' },
  ...
  { text: 'Wallet missing, you had it 10 minutes ago', theme: 'out', box: 'now', tier: 2,
  ...
  { text: 'Alarm failed, school starts in 30 minutes', theme: 'out', box: 'now', tier: 2,
    why: 'Every minute you spend deciding is a minute late.' },
  ...
  /* ---------- out: DO LATER ---------- */
  { text: 'Book dentist check-up, no pain yet', theme: 'out', box: 'later', tier: 2,
    why: 'Ignore it and it becomes a Do Now with toothache.' },
  { text: 'Exercise, you have not moved all week', theme: 'out', box: 'later', tier: 2,
  ...
  { text: 'Replace the shoes falling apart', theme: 'out', box: 'later', tier: 3,
  ...
  { text: 'Snacks needed for the meet-up at 4pm', theme: 'out', box: 'give', tier: 3,
    why: 'You offered first, so it feels yours. It is still an errand.' },
  { text: 'Borrowed umbrella must go back today', theme: 'out', box: 'give', tier: 3,
    why: 'You borrowed it, but whoever sees them first can hand it over.' },
  ...
  { text: 'Wander the same aisle for the third time', theme: 'out', box: 'drop', tier: 2,
    why: 'You are not shopping any more, you are just walking.' },
