...
var CARDS = [
  ...
  { text: 'Rain starting and mum hung the washing out', theme: 'house', box: 'now', tier: 1,
  ...
  { text: 'Get someone to teach you one meal properly', theme: 'house', box: 'later', tier: 1,
  ...
  { text: 'Everyone says it gets good, you are bored now', theme: 'house', box: 'drop', tier: 1,
  ...
  { text: 'Storage full, your group is waiting on a photo', theme: 'phone', box: 'now', tier: 2,
    why: 'Nothing on the phone works until you clear some. Only you can.' },
